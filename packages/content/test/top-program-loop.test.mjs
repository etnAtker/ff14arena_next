...
test('欧米茄绝境战 P1 循环程序：同一塔多名有效玩家会全部消耗编号状态', () => {
  withMockedRandom([0.91, 0.17, 0.73, 0.44, 0.28, 0.62, 0.05], () => {
    ...
    submitPose(simulation, handlers[0], firstRound.towerPositions[0], ++inputSeq);
    submitPose(simulation, handlers[1], firstRound.towerPositions[0], ++inputSeq);
    submitPose(simulation, handlers[2], firstRound.towerPositions[1], ++inputSeq);
...
test('欧米茄绝境战 P1 循环程序：循环程序状态到期未消除会触发遗忘死亡', () => {
  withMockedRandom([0.91, 0.17, 0.73, 0.44, 0.28, 0.62, 0.05], () => {
    ...
    submitPose(simulation, firstActor, { x: 0, y: 0 }, ++inputSeq);
    submitPose(simulation, substituteHandlers[0], firstRound.towerPositions[0], ++inputSeq);
    submitPose(simulation, substituteHandlers[1], firstRound.towerPositions[1], ++inputSeq);
