...
const TERMINAL_CIRCLE_SPAWN_ATS = [143_100, 146_100] as const;
const TERMINAL_CIRCLE_DELAY_MS = 3_000;
const TERMINAL_CIRCLE_RADIUS = 5;
const TERMINAL_SHARE_ASSIGN_ATS = [143_100, 149_100] as const;
...
const TERMINAL_MOVEMENT_CHECK_AT = 158_100;
const TERMINAL_SHARE_RETURN_AT = 159_100;
